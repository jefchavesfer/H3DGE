...
const char * const pcTaskStartMsg = "Create task started.\r\n";
	...
	for( ;; )
	{
		...
		xTaskCreate( vSuicidalTask, ( signed char * )"SUICIDE1", deathSTACK_SIZE, NULL, uxPriority, &xCreatedTask1 );
		xTaskCreate( vSuicidalTask, ( signed char * )"SUICIDE2", deathSTACK_SIZE, &xCreatedTask1, uxPriority, NULL );

		xTaskCreate( vSuicidalTask, ( signed char * )"SUICIDE1", deathSTACK_SIZE, NULL, uxPriority, &xCreatedTask2 );
		xTaskCreate( vSuicidalTask, ( signed char * )"SUICIDE2", deathSTACK_SIZE, &xCreatedTask2, uxPriority, NULL );
