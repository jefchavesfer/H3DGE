...
module user_logic
  (
   ...
   Coproc_Clk,                     // Clock that goes into ray tracing modules
   ...
   intersectionModule  intersector(Coproc_Clk, Bus2IP_Reset, int_start,
                                   int_ray, int_triangle, 0, int_ready,
                                   int_t, int_code);

   // Slave registers-to-coprocessor mapping
   assign
     int_start = slv_reg0[0],
     int_ray.start.x = slv_reg1,
     int_ray.start.y = slv_reg2,
     int_ray.start.z = slv_reg3,
     int_ray.dir.x = slv_reg4,
     int_ray.dir.y = slv_reg5,
     int_ray.dir.z = slv_reg6,
     int_triangle.v1.x = slv_reg7,
     int_triangle.v1.y = slv_reg8,
     int_triangle.v1.z = slv_reg9,
     int_triangle.v2.x = slv_reg10,
     int_triangle.v2.y = slv_reg11,
     int_triangle.v2.z = slv_reg12,
     int_triangle.v3.x = slv_reg13,
     int_triangle.v3.y = slv_reg14,
     int_triangle.v3.z = slv_reg15;
   ...
   always @( slv_reg_read_sel or slv_reg0 or slv_reg1 or slv_reg2 or slv_reg3 or slv_reg4 or slv_reg5 or slv_reg6 or slv_reg7 or slv_reg8 or slv_reg9 or slv_reg10 or slv_reg11 or slv_reg12 or slv_reg13 or slv_reg14 or slv_reg15 or slv_reg16 or slv_reg17 or slv_reg18 or slv_reg19 )
     begin: SLAVE_REG_READ_PROC
        ...
        case ( slv_reg_read_sel )
          20'b10000000000000000000 : slv_ip2bus_data <= {slv_reg0[0],
                                                         int_ready,
                                                         int_code};
          20'b01000000000000000000 : slv_ip2bus_data <= int_t;
          20'b00100000000000000000 : slv_ip2bus_data <= slv_reg2;
          20'b00010000000000000000 : slv_ip2bus_data <= slv_reg3;
          20'b00001000000000000000 : slv_ip2bus_data <= slv_reg4;
          ...
          20'b00000000000000000001 : slv_ip2bus_data <= slv_reg19;
