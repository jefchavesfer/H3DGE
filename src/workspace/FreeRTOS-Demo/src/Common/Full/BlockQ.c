...
const portTickType xDontBlock = ( portTickType ) 0;
	...
	xTaskCreate( vBlockingQueueProducer, ( signed char * )"QProdB3", blckqSTACK_SIZE, ( void * ) pxQueueParameters3, tskIDLE_PRIORITY, NULL );
	xTaskCreate( vBlockingQueueConsumer, ( signed char * )"QConsB4", blckqSTACK_SIZE, ( void * ) pxQueueParameters4, uxPriority, NULL );
